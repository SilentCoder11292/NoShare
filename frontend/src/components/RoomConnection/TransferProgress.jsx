...
export default function TransferProgress({ transferringFile, currentFileIndex, fileQueueLength, transferProgress, transferSpeed, onCancel, role }) {
  ...
  return (
    <div className="progress-card">
      ...
      <button 
        ...
        style={{ marginTop: '0.5rem', color: 'var(--color-error)', borderColor: 'rgba(239, 68, 68, 0.2)' }}
      >
        Cancel Transfer
      </button>
    </div>
